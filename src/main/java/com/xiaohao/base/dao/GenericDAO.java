...
public interface GenericDAO<T extends Serializable, PK extends Serializable>
	 ...
	 * @return
	 */
	public Page sqlQueryForPage(String listSql, Object[] params, int pagestart, int pagesize, LinkedHashMap<String, String> orderby);
	 ...
	 * @return
	 */
	public Page sqlQueryForPage(String listSql, Object[] params, LinkedHashMap<String, String> orderby);
	/**
	 * 通过SQL查询实体列表
	 * @param sql 查询的sql
	 * @param params 参数
	 * @param rowMapper 对象映射接口
	 * @return
	 ...
	 * 根据查询条件查询对象
	 * example:
	 * 	QueryCondition conn = new QueryCondition();
	 * 
	 *	conn.putCondition("productName", "test001")
	 *		.putCondition("categoryId",12288)
	 *		.addOrder("checkDate");
	 *
