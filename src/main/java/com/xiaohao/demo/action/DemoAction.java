package com.xiaohao.demo.action;

import com.xiaohao.demo.model.Demo;
import com.xiaohao.demo.service.DemoService;
...
@Controller
@Actions({ @Action(value = ("/tbArbitrateAction"), results = {
        @Result(name = "input", location = "/WEB-INF/pages/servicemanager/arbitratemanager.jsp"),
        @Result(name = "infopage", location = "/WEB-INF/pages/servicemanager/arbitrateinfo.jsp"),
